...
public final class FragmentMeBinding implements ViewBinding {
  ...
  private FragmentMeBinding(@NonNull LinearLayout rootView, @NonNull TextView tvAge,
      @NonNull TextView tvDesc, @NonNull TextView tvId, @NonNull TextView tvName) {
  ...
  public static FragmentMeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMeBinding((LinearLayout) rootView, tvAge, tvDesc, tvId, tvName);
    }
